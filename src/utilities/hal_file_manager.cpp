...
namespace hal
{
    namespace hal_file_manager
    {
        namespace
        {
            CallbackHook<bool(const std::experimental::filesystem::path&, Netlist* netlist, rapidjson::Document&)> m_on_serialize_hook;
            CallbackHook<bool(const std::experimental::filesystem::path&, Netlist* netlist, rapidjson::Document&)> m_on_deserialize_hook;
        }    // namespace
        ...
        void register_on_serialize_callback(const std::string& identifier, std::function<bool(const std::experimental::filesystem::path&, Netlist* netlist, rapidjson::Document&)> callback)
        {
        ...
        void register_on_deserialize_callback(const std::string& identifier, std::function<bool(const std::experimental::filesystem::path&, Netlist* netlist, rapidjson::Document&)> callback)
        {
